    ...
    <div class="logo">
      <a href="javascript:;" @click="GoRouter" data-router="index">
        ...
        <span data-router="index" :class="{font:isIndex==0}">
          <span :class="{font:isIndex==0}" style="font-size:20px;">BUG民宿</span> 家的感觉
        </span>
      </a>
    </div>
    <!-- 头部右侧导航 -->
    <div class="nav">
      <div>
        <a
          ...
          @click="GoRouter"
          data-router="index"
          :class="{'font-color':isIndex==0,font:isIndex==0,color:isIndex==0}"
        >GoHome</a>
      </div>
      <div class="login">
        <div v-if="!UserName">
        ...
        <div @mouseenter="Up" @mouseleave="Down" v-if="UserName">
          ...
          <div @click="GoRouter" class="navlist" v-show="show">
            <ul v-show="isHoster=='1'">
              <li>房东中心</li>
              <li>
                <a href="javascript:;" data-isaictivea="1" data-router="adminorder/list">订单管理</a>
              </li>
              <li>
                <a href="javascript:;" data-isaictivea="2" data-router="adminorder/settlement">结算统计</a>
              </li>
              <li>
                <a href="javascript:;" data-isaictivea="6" data-router="adminorder/baseinfor">房源信息</a>
              </li>
              <li>
                <a href="javascript:;" data-router>价格房态</a>
              </li>
              <li>
                <a href="javascript:;" data-isaictivea="7" data-router="adminorder/Admin_to">个人资料</a>
              </li>
              <li>
                <a href="javascript:;" data-isaictivea="5" data-router="adminorder/favorites">我的收藏</a>
              </li>
            </ul>
            <ul>
              <li>房客中心</li>
              <li>
                <a href="javascript:;" data-isaictivea="1" data-router="adminorder/list">我的订单</a>
              </li>
              <li>
                <a href="javascript:;" data-isaictivea="7" data-router="adminorder/Admin_to">个人资料</a>
              </li>
              ...
              <li>
                <a href="javascript:;" data-isaictivea="3" data-router="adminorder/msg">通知</a>
              </li>
            </ul>
            <div>
