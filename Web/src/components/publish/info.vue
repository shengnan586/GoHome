      ...
      <div class="address_box">
        <div class="clearfix">
          ...
          <div class="address_list" style="position:relative;">
            ...
            <div  class="error_panel" v-show="err_address" style="display: block;top:20px;left:140px;">
          ...
          <div class="o_address clearfix">
            ...
            <div class="o_addBottom">
              <div style="position:relative;">
                ...
                <div  class="error_panel" v-show="err_detail" style="display: block;top:28px;left:450px;">
                    <i  class="iconfont icon-jinggao"></i>
                    <div  class="el-alert_content">
              ...
              <div style="position:relative;">
                ...
                <div  class="error_panel" v-show="err_num" style="display: block;top:28px;left:450px;">
                    <i  class="iconfont icon-jinggao"></i>
                    <div  class="el-alert_content">
              ...
              <div style="text-align: center;">
                <a href="javascript:;" class="o_sure_big f18 site_submit_btn" id="site_submit" @click="submit">确定</a>
                <a href="javascript:;" class="o_sure_big f18 site_cancle_btn" id="site_cancle" @click="cancle">取消</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <ul>
                ...
                <li class="clearfix" style="padding-bottom:15px;position:relative;">
                    ...
                    <div class="h_house_r clearfix" >
                        <div class="h_input_box" style="width: 120px;">
                            <input type="text"  v-model="area"  placeholder="请填写" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " maxlength="4" @focus="err_areaShow">
                        </div>
                ...
                <li class="clearfix" style="padding-bottom:15px;">
                    ...
                    <select  class="h_input_box" v-model="bathId">
                        <option v-for="(item,i) of bathList"
                    :key="i" :value="item.id" v-text="item.typeName"></option>
                    </select>
                </li>
                <li class="clearfix" style="padding-bottom:15px;">
                    ...
                    <div class="bed_select">
                        <select  class="h_input_box" v-model="bedTypeId">
                            <option v-for="(item,i) of bedList"
                ...
                <li class="clearfix" style="padding-bottom:15px;">
                    ...
                    <span style="line-height: 40px;font-size:12px;color:#757575">请填写<span style="color:#39b54a;">最适宜居住的人数</span>，而不是最多入住人数。（如有需要，请在“加客设置”中填写）
                    <p id="tantnumDesc" style="margin-left: 103px;font-size:12px;color:#757575">根据你填写的床铺信息，建议宜居人数为<span style="color: #ff0000;">2人</span></p>
                    </span>
                    <div>
                        <select v-model="peoples" class="h_input_box" style="margin-left: 100px;margin-top: 10px;">
                        <option :value="i"  v-for="(item,i) of 10" :key="i" v-text="i"></option>
                    </select>
...
export default {
  ...
  methods: {
    load() {
        ...
        this.axios.get("houseType",{params:{dicType:3 }})
        .then(result=>{
            this.bathList=result.data;
            this.bathId = result.data[0].id;
        })
        this.axios.get("bedType")
        .then(result=>{
    ...
    submit(){
        if(!this.details_address){
            ...
            this.address="北京市"+detail+this.details_address+this.house_num;
            this.isShow=false;
