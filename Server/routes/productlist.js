...
router.get("/GetProduct", (req, res) => {
    ...
    if(bedroom){
        sql +=" and apartment.bedroom=? "; //几居室
    }
    if(houseDESC){
        sql +=" and house.houseDESC like CONCAT('%',?,'%')"; //房源介绍--关键字
    }
    ...
    pool.query(sql, [rentalTypeId,peopleNumber,aId,bedroom,houseDESC,smallprice,bigprice,smallprice,bigprice,smallprice,bigprice,checkinDate,checkoutDate], (err, result) => {
        if (err) throw err;
...
// http://127.0.0.1:3003/productlist/GetProduct?rentalTypeId=14&peopleNumber=5&aId=2&bedroom=1&houseDESC='房源'&smallprice=80&bigprice=100&checkinDate='20190814'&checkoutDate='20190815'
